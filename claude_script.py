...
def extract_plan_name_and_sections(output: str) -> tuple[Optional[str], Optional[str], Optional[str]]:
...
async def _main() -> None:
    ...
    extracted_plan_name, extracted_plan, extracted_questions = extract_plan_name_and_sections(iteration_0_output)
